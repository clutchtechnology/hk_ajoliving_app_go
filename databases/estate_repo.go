...
type EstateRepository interface {
	Create(ctx context.Context, estate *models.Estate) error
	GetByID(ctx context.Context, id uint) (*models.Estate, error)
	Update(ctx context.Context, estate *models.Estate) error
	Delete(ctx context.Context, id uint) error
	List(ctx context.Context, req *models.ListEstatesRequest) ([]*models.Estate, int64, error)
	GetProperties(ctx context.Context, estateID uint, listingType string, page, pageSize int) ([]*models.Property, int64, error)
	GetImages(ctx context.Context, estateID uint) ([]models.EstateImage, error)
	GetFacilities(ctx context.Context, estateID uint) ([]models.Facility, error)
	GetStatistics(ctx context.Context, estateID uint) (*models.Estate, error)
	GetFeatured(ctx context.Context, limit int) ([]*models.Estate, error)
...
func (r *estateRepository) Create(ctx context.Context, estate *models.Estate) error {
	return r.db.WithContext(ctx).Create(estate).Error
}

func (r *estateRepository) GetByID(ctx context.Context, id uint) (*models.Estate, error) {
...
func (r *estateRepository) Update(ctx context.Context, estate *models.Estate) error {
...
func (r *estateRepository) List(ctx context.Context, req *models.ListEstatesRequest) ([]*models.Estate, int64, error) {
...
func (r *estateRepository) GetProperties(ctx context.Context, estateID uint, listingType string, page, pageSize int) ([]*models.Property, int64, error) {
	var properties []*models.Property
	var total int64

	query := r.db.WithContext(ctx).Model(&models.Property{}).Where("estate_id = ?", estateID)
...
func (r *estateRepository) GetImages(ctx context.Context, estateID uint) ([]models.EstateImage, error) {
...
func (r *estateRepository) GetFacilities(ctx context.Context, estateID uint) ([]models.Facility, error) {
...
func (r *estateRepository) GetStatistics(ctx context.Context, estateID uint) (*models.Estate, error) {
	var estate models.Estate
	err := r.db.WithContext(ctx).
...
func (r *estateRepository) GetFeatured(ctx context.Context, limit int) ([]*models.Estate, error) {
	var estates []*models.Estate
	err := r.db.WithContext(ctx).
