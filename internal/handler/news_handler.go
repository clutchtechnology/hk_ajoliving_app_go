...
// @Success 200 {object} response.PaginatedResponse{data=[]response.NewsListItemResponse}
// @Failure 400 {object} response.Response
// @Failure 500 {object} response.Response
// @Router /api/v1/news [get]
func (h *NewsHandler) ListNews(c *gin.Context) {
	var filter request.ListNewsRequest
	...
	response.SuccessWithPagination(c, news, &response.Pagination{
		Page:      filter.Page,
...
// @Accept json
// @Produce json
// @Success 200 {object} response.Response{data=[]response.NewsCategoryResponse}
// @Failure 500 {object} response.Response
...
// @Success 200 {object} response.Response{data=response.NewsResponse}
// @Failure 400 {object} response.Response
...
// @Accept json
// @Produce json
// @Success 200 {object} response.Response{data=[]response.NewsListItemResponse}
// @Failure 500 {object} response.Response
...
// @Produce json
// @Param id path int true "新闻ID"
// @Success 200 {object} response.Response{data=[]response.RelatedNewsResponse}
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
