...
type SearchRepository interface {
	// 搜索相关
	SearchProperties(ctx context.Context, keyword string, filters *request.SearchPropertiesRequest) ([]*model.Property, int64, error)
	SearchEstates(ctx context.Context, keyword string, districtID *uint, page, pageSize int) ([]*model.Estate, int64, error)
	SearchAgents(ctx context.Context, keyword string, districtID *uint, page, pageSize int) ([]*model.Agent, int64, error)
	SearchNews(ctx context.Context, keyword string, limit int) ([]*model.News, error)
	...
	// 搜索历史
	SaveSearchHistory(ctx context.Context, history *model.SearchHistory) error
	GetSearchHistory(ctx context.Context, userID *uint, searchType *string, page, pageSize int) ([]*model.SearchHistory, int64, error)
...
func (r *searchRepository) SearchProperties(ctx context.Context, keyword string, filters *request.SearchPropertiesRequest) ([]*model.Property, int64, error) {
...
// SearchEstates 搜索屋苑
func (r *searchRepository) SearchEstates(ctx context.Context, keyword string, districtID *uint, page, pageSize int) ([]*model.Estate, int64, error) {
...
// SearchAgents 搜索代理人
func (r *searchRepository) SearchAgents(ctx context.Context, keyword string, districtID *uint, page, pageSize int) ([]*model.Agent, int64, error) {
...
// SearchNews 搜索新闻
func (r *searchRepository) SearchNews(ctx context.Context, keyword string, limit int) ([]*model.News, error) {
	var news []*model.News
...
func (r *searchRepository) SaveSearchHistory(ctx context.Context, history *model.SearchHistory) error {
	return r.db.WithContext(ctx).Create(history).Error
}

// GetSearchHistory 获取搜索历史
func (r *searchRepository) GetSearchHistory(ctx context.Context, userID *uint, searchType *string, page, pageSize int) ([]*model.SearchHistory, int64, error) {
	var histories []*model.SearchHistory
	var total int64

	query := r.db.WithContext(ctx).Model(&model.SearchHistory{})
